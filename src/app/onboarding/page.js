...
const OnBoarding = () => {
  ...
  const [isConstituentPartnerSelected, setIsConstituentPartnerSelected] =
    useState(0);
  ...
  const [isCorporationBenificialSelected, setIsCorporationBenificialSelected] =
    useState(0);
      ...
      submitters: [
        {
          ...
          values: {
            ...
            type_entity: `${
              answers?.isSingle ? "Single Asset" : "Multi Asset" || "No Data"
            }`,
            ...
            president_name_01: `${
              answers?.Associates?.Company?.RepresentativeDetails?.FirstName ||
              answers?.Associates?.Person[0]?.NaturalPerson?.FirstName ||
              "No Data"
            }`,
            ...
            name_of_signature_entity: `${
              answers?.Associates?.Company?.RepresentativeDetails?.FirstName ||
              answers?.Associates?.Person[0]?.NaturalPerson?.FirstName ||
              "No Data"
            }`,
            pouvoir_name_entity: `${answers?.shape || "No Data"}`,
            pouvoir_legal_entity: `${
              answers?.Associates?.Company?.CompanyDetail?.CompanyName ||
              "No Data"
            }`,
            pouvoir_address_entity: `${
              answers?.Associates?.Company?.CompanyDetail?.HeadOffice ||
              "No Data"
            }`,
            legal_representative_entity: `${
              answers?.Associates?.Company?.RepresentativeDetails?.FirstName ||
              "No Data"
            }`,
            president_name_02: `${
            ...
            legal_representative_president: `${
              answers?.Associates?.Company?.RepresentativeDetails?.FirstName ||
              answers?.Associates?.Person[0]?.NaturalPerson?.FirstName ||
              "No Data"
            }`,
            ...
            president_nationality: `${
              answers?.Management?.Person?.PersonalDetails?.Nationality ||
              "No Data"
            }`,
            president_dob: `${
              formatDate(
                answers?.Management?.Person?.PersonalDetails?.DateOfBirth
              ) || "No Data"
            }`,
            presiden_birth_place: `${
              answers?.Management?.Person?.PersonalDetails?.PlaceOfBirth ||
              "No Data"
            }`,
            president_address: `${
              answers?.Management?.Person?.PersonalDetails?.PlaceOfResident ||
              "No Data"
            }`,
            president_father_name: `${
              answers?.Management?.Person?.FatherMotherDetails?.FatherName ||
              "No Data"
            }`,
            father_dob: `${
              formatDate(
                answers?.Management?.Person?.FatherMotherDetails
                  ?.FatherDateOfBirth
              ) || "No Data"
            }`,
            father_birth_place: `${
              answers?.Management?.Person?.FatherMotherDetails
                ?.FatherPlaceOfBirth || "No Data"
            }`,
            president_mother_name: `${
              answers?.Management?.Person?.FatherMotherDetails?.MotherName ||
              "No Data"
            }`,
            mother_birth_place: `${
              answers?.Management?.Person?.FatherMotherDetails
                ?.MotherPlaceOfBirth || "No Data"
            }`,
            mother_dob: `${
              formatDate(
                answers?.Management?.Person?.FatherMotherDetails
            ...
            type_of_declaration_entity: `${
              answers?.isSingle ? "Single Asset" : "Multi Asset" || "No Data"
            }`,
            address_of_declaration_entity: `${
              answers?.wallet?.headOffice || "No Data"
            }`,
          },
        },
      ],
  ...
  const FatherMotherSchema = yup.object().shape({
    ...
    FatherDateOfBirth: yup
      .date()
      .nullable()
      .required("Father Date of birth is required"),
    FatherPlaceOfBirth: yup
      .string()
      .required("Father Place of birth is required"),
    FatherPlaceOfResident: yup
      .string()
      .required("Father Place of residence is required"),
    MotherName: yup.string().required("Mother Name is required"),
    MotherFirstName: yup.string().required("Mother First Name is required"),
    MotherDateOfBirth: yup
      .date()
      .nullable()
      .required("Mother Date of birth is required"),
    MotherPlaceOfBirth: yup
      .string()
      .required("Mother Place of birth is required"),
    MotherPlaceOfResident: yup
      .string()
      .required("Mother Place of residence is required"),
  });
  ...
  const corporationLegalRepresentationSchema = yup.object().shape({
    ...
    AmountContribution: yup
      .string()
      .required("Amount Contribution is required"),
  });

  const {
    register: corporationLegalRepresentationRegister,
  ...
  const {
    register: corporationBeneficiaryRegister,
  ...
  const {
    register: otherBenificialRegister,
  ...
  const physicalPersonOnSubmit = (data) => {
    ...
    setAnswers({
      ...
      Management: {
        ...
        Person: {
          ...answers?.Management?.Person,
          PersonalDetails: { ...data?.Management?.Person?.PersonalDetails },
        },
      },
    });
    handleQuestions(true); // Use this data for further processing or API calls
  ...
  const effectBeneficiaryDocumentSchema = yup.object().shape({
    Document: yup
      .string()
      .test("fileSize", "Please Upload the document", (value) => {
        return true;
      }),
  });

  const {
    register: effectBeneficiaryDocumentRegister,
  ...
  const effectBeneficiaryDocumentOnSubmit = (data) => {
    ...
    const currentEffectiveBeneficiaries =
      answers?.Associates?.Company?.EffectiveBeneficiaries || [];
    const updatedEffectiveBeneficiaries = [
      ...currentEffectiveBeneficiaries.slice(0, -1),
      {
        ...currentEffectiveBeneficiaries[
          currentEffectiveBeneficiaries.length - 1
        ],
    ...
    isOtherBenificialSelected
      ? handleQuestions(true)
      : handleQuestions(true, -15);
  ...
  const {
    register: corporationLegalRegister,
  ...
  const {
    register: constituentBeneficiaryRegister,
    ...
    setAnswers({
      ...
      ConstituentPartner: {
        ...
        Company: {
          ...answers?.ConstituentPartner?.Company,
          EffectiveBeneficiaries: [
            ...answers?.ConstituentPartner?.Company?.EffectiveBeneficiaries,
            { ...data },
          ],
        },
      },
  ...
  const {
    register: constituentDocumentRegister,
  ...
  const constituentDocumentOnSubmit = (data) => {
    ...
    setAnswers({
      ...
      ConstituentPartner: {
        ...
        Company: {
          ...answers?.ConstituentPartner?.Company,
          EffectiveBeneficiaries: updatedDocuments,
        },
      },
    });

    isCorporationBenificialSelected
      ? handleQuestions(true, -1)
      : handleQuestions(true, -23);
  ...
  const {
    register: constituentPersonRegister,
  ...
  const {
    register: constituentDocumentPersonRegister,
  ...
  const {
    register: managementCorporationRegister,
  ...
  const {
    register: managementLegalRegister,
  ...
  const {
    register: associateDocumentPersonRegister,
  ...
  const {
    register: managementDocumentRegister,
  ...
  const {
    register: otherBeneficiaryDocumentRegister,
  ...
  const otherBeneficiaryDocumentOnSubmit = (data) => {
    ...
    isAgainBenificialSelected
      ? handleQuestions(false, 1)
      : handleQuestions(true, -17);
  ...
  const {
    register: managementLegalDocumentRegister,
  ...
  const handleSelectPerson = (selectedPerson) => {
    ...
    const selectedPersonData = newFilteredData.find(
  ...
  function getLastBeneficiaryFirstName(answers, type) {
    if (type == "associate") {
      const effectiveBeneficiaries =
        answers?.Associates?.Company?.EffectiveBeneficiaries;

      if (effectiveBeneficiaries?.length > 0) {
        const lastBeneficiary =
          effectiveBeneficiaries[effectiveBeneficiaries.length - 1];
  ...
  return (
    <div className="relative">
            ...
            <div className="mt-[80px] flex items-start justify-center">
              <div className="flex flex-col gap-[20px] w-[559px]">
                <div className="p-[16px] rounded-[8px] bg-[#F9F6F4]">
                  ...
                  <div className="">
                    <p className="pb-[20px] text-[14px] font-[300] text-[#878583]">
                      Embark on your journey by engaging with our Questionnaire.
                      Simply click the button below to begin. We're excited to
                      hear from you!
                    </p>
                    <button
                ...
                <div className="p-[16px] rounded-[8px] bg-[#F9F6F4]">
                  ...
                  <div className="">
                    <p className="pb-[20px] text-[14px] font-[300] text-[#878583]">
                      To finalize the documentation process efficiently, kindly
                      use the button provided below to electronically sign your
                      documents. This e-signature step is a convenient and
                      secure way to complete the required formalities swiftly.
                    </p>
                    <button
                      onClick={async () => {
      ...
      {isQuestionOpen ? (
        <div
          className={`absolute h-full w-full top-0 left-0 bg-transparant ${
            activeQuestion === 11 ? "mt-[100px]" : ""
          } `}
        >
          <div className="flex justify-center items-start my-[100px] h-screen">
              ...
              {
                {
                      ...
                      <div className="py-[50px]">
                        ...
                        <div className="pt-[20px] flex flex-col gap-[10px] w-[70%]">
                          <div
                            ...
                            className={`${
                              answers.isSingle ? "border-[2px]" : "border"
                    ...
                    <>
                      <div className="py-[50px] relative">
                        ...
                        <div className="pt-[20px] flex flex-col gap-[10px] w-[40%]">
                          ...
                          <div
                            onClick={() => {
                              handleShape("Joint stock company");
                              openPopup();
                            }}
                            className={`${
                              answers.shape === "Joint stock company"
                                ? "border-[2px]"
                                : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                            ...
                            <div className="fixed inset-2 flex items-center justify-center  m-auto mt-[-15%] bg-gray-100 w-full">
                              <div className="bg-white p-8 rounded shadow-md w-[40%]  ">
                                ...
                                <p className="text-lg font-semibold text-[#315B3F] ">
                                  Please note that to use a PEA we need to
                                  establish a Société par Actions Simplifiée
                                  which is subject to corporate tax. While a PEA
                                  will exonerate the investors using their PEA
                                  (and only those investors, so not investors
                                  without PEA) of 13% tax on the proceeds
                                  received from the entity, the entity will be
                                  subject to corporate tax of 25% unless the
                                  entity owns at least 5% of the shares of the
                                  target for more than 2 years (in which case,
                                  the corporate tax will only be 3%). Otherwise,
                                  we can establish a Société Civile which is not
                                  subject to corporate tax but does not allow
                                  PEA. In Conclusion, a PEA with a société par
                                  action simplifée is the best solution only
                                  when the entity will hold more than 5% of the
                                  target for more than 2 years.
                                </p>
                                <button
                                  onClick={() => {
                                    closePopup();
                      ...
                      <div className="py-[50px]">
                        ...
                        <div className="pt-[20px] flex flex-col gap-[10px] w-[70%]">
                          <div
                            ...
                            className={`${
                              !isSelectedCorporation ? "border-[2px]" : "border"
                          ...
                          <div className="relative inline-block left-[390px] bottom-14">
                            <IoIosInformationCircle
                              className="text-[#315B3F] cursor-pointer"
                              title="An individual who participated in the SPV as an investor, manager, or owner, bringing personal expertise or capital"
                            />
                          </div>
                          <div
                  ...
                  6: (
                    <>
                      <form
                        onSubmit={naturalPersonHandleSubmit(
                          naturalPersonOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                          ...
                          <div className="flex flex-col gap-[20px]">
                            ...
                            <div className="flex w-full items-center relative">
                              ...
                              />
                              {naturalPersonErrors.NaturalPerson
                                ?.DateOfBirth && (
                                <span className="text-[11px] text-[red] absolute bottom-[-17px] left-[220px]">
                    ...
                    <>
                      <div className="py-[50px]">
                        ...
                        <div className="flex flex-col gap-1 justify-start items-start">
                          <button
                            onClick={() =>
                              setIsConstituentPartnerSelected(true)
                            }
                            className={`${
                              isConstituentPartnerSelected
                                ? "border-[2px]"
                                : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                          ...
                          <button
                            onClick={() =>
                              setIsConstituentPartnerSelected(false)
                            }
                            className={`${
                              !isConstituentPartnerSelected
                                ? "border-[2px]"
                    ...
                    <>
                      <div className="py-[50px]">
                        ...
                        <div className="flex flex-col gap-3 items-start relative">
                          <button
                            onClick={() => setIsCorporationSelected(false)}
                            className={`${
                              !isCorporationSelected ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                            title="An individual who participated in the SPV as an investor, manager, or owner, bringing personal expertise or capital."
                          >
                            Physical Person
                          ...
                          <button
                            onClick={() => setIsCorporationSelected(true)}
                            className={`${
                              isCorporationSelected ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                        ...
                        <div>
                          <button
                            onClick={() => {
                              ...
                              isCorporationSelected
                                ? handleQuestions(true, 8)
                                : handleQuestions(true, 1);
                            }}
                            type="button"
                  ...
                  10: (
                    <>
                      <div className="py-[0px] mt-5">
                        <p className="pb-[0px] text-[25px] font-[500] text-[#315B3F]">
                          Management{" "}
                        </p>
                        <p
                          className="pb-[0px] text-[15px] underline font-[500] text-[#315B3F] mt-2 relative"
                          title="An individual who participated in the SPV as an investor, manager, or owner, bringing personal expertise or capital."
                        >
                          Physical Person
                        </p>
                        ...
                        <div className="flex w-full items-center relative mb-4">
                          ...
                          >
                            ...
                            {answers?.Associates?.Person.map((person) => {
                              ...
                              return (
                                <option key={newData.Name} value={newData.Name}>
                                  {newData.Name}
                                </option>
                              );
                            })}
                        ...
                        <form
                          onSubmit={physicalPersonHandleSubmit(
                            physicalPersonOnSubmit
                          )}
                        >
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                {...physicalPersonRegister(
                                  "Management.Person.PersonalDetails.FirstName"
                                )}
                                type="text"
                              />
                              {physicalPersonErrors.Management?.Person
                                ?.PersonalDetails?.FirstName && (
                                <span className="text-[11px] text-[red] absolute left-[220px] bottom-[-15px]">
                                  {
                                    physicalPersonErrors.Management.Person
                                      .PersonalDetails.FirstName.message
                                  }
                                </span>
                              )}
                            </div>
                            ...
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                {...physicalPersonRegister(
                                  "Management.Person.PersonalDetails.Name"
                                )}
                                type="text"
                              />
                              {physicalPersonErrors.Management?.Person
                            ...
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                {...physicalPersonRegister(
                                  "Management.Person.PersonalDetails.DateOfBirth"
                                )}
                              />
                              {physicalPersonErrors.Management?.Person
                            ...
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                {...physicalPersonRegister(
                                  "Management.Person.PersonalDetails.PlaceOfBirth"
                                )}
                                type="text"
                              />
                              {physicalPersonErrors.Management?.Person
                                ...
                                <span className="text-[11px] text-[red] absolute left-[220px] bottom-[-15px]">
                                  {
                                    physicalPersonErrors.Management.Person
                                      .PersonalDetails.PlaceOfBirth.message
                                  }
                                </span>
                              )}
                            </div>
                            ...
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                {...physicalPersonRegister(
                                  "Management.Person.PersonalDetails.PlaceOfResident"
                                )}
                                type="text"
                              />
                              {physicalPersonErrors.Management?.Person
                                ?.PersonalDetails?.PlaceOfResident && (
                                <span className="text-[11px] text-[red] absolute left-[220px] bottom-[-15px]">
                                  {
                                    physicalPersonErrors.Management.Person
                                      .PersonalDetails.PlaceOfResident.message
                                  }
                                </span>
                              )}
                            </div>
                  ...
                  11: (
                    <>
                      <form
                        onSubmit={fatherMotherHandleSubmit(
                          fatherMotherOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                          ...
                          <p
                            className="pb-[10px] text-[15px] underline font-[500] text-[#315B3F]"
                            title="An individual who participated in the SPV as an investor, manager, or owner, bringing personal expertise or capital."
                          >
                            Physical Person
                          </p>
                  ...
                  12: (
                    <>
                      <div className="py-[50px]">
                        <form
                          onSubmit={ManagementDocumentHandleSubmit(
                            ManagementDocumentOnSubmit
                          )}
                        >
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                            Management{" "}
                          ...
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full flex-col items-start relative">
                              ...
                              <p className="pb-[20px] text-[17px] font-[500] text-[#315B3F]">
                                Person Name :{" "}
                                {
                                  answers?.Management?.Person?.PersonalDetails
                                    ?.FirstName
                                }{" "}
                              </p>
                    ...
                    <>
                      <div className="py-[25px]">
                        ...
                        <div className="relative inline-block left-[165px] bottom-[35px]">
                          <IoIosInformationCircle
                            className="text-[#315B3F] cursor-pointer"
                            title="Indicates the fee, typically a fixed percentage of the assets under management, charged by the General Partner or management team for operating the SPV. This fee covers administrative and operational expenses related to managing the investment."
                          />
                        </div>
                  ...
                  14: (
                    <>
                      <form
                        onSubmit={admissionFeeHandleSubmit(
                          admissionFeeOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                      ...
                      <div className="py-[50px]">
                        ...
                        <div className="flex flex-col gap-1 justify-start items-start mb-5">
                          ...
                          <div className="relative inline-block left-[150px] bottom-[25px]">
                            <IoIosInformationCircle
                              className="text-[#315B3F] cursor-pointer"
                              title="Enter the rate of return investors receive from the SPV's income before any profit-sharing. This ensures investors get a return on their investment before other distributions."
                            />
                          </div>

                          <button
                            value="yes"
                            onClick={() => setIsPrioritySelected(true)}
                            className={`${
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setAnswers({
                                      ...answers,
                                      PerformanceFees: {
                                        ...answers?.PerformanceFees,
                                        PerformancePercentage: e.target.value,
                                      },
                                    })
                                  }
                                />
                        ...
                        <div className="flex flex-col gap-1 justify-start items-start mb-5">
                          ...
                          <div className="relative inline-block left-[130px] bottom-[25px]">
                            <IoIosInformationCircle
                              className="text-[#315B3F] cursor-pointer"
                              title="Specify the arrangement where the General Partner receives a share of profits after investors have received their priority interest. This occurs once investors achieve their agreed-upon return."
                            />
                          </div>
                          <button
                            onClick={() => setIsGpCatchUpSelected(true)}
                            className={`${
                              isGpCatchUpSelected ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                            Yes
                          </button>
                          <button
                            onClick={() => setIsGpCatchUpSelected(false)}
                            className={`${
                              !isGpCatchUpSelected ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                        ...
                        <div className="flex flex-col gap-1 justify-start items-start mb-5">
                          ...
                          <div className="relative inline-block left-[85px] bottom-[25px]">
                            <IoIosInformationCircle
                              className="text-[#315B3F] cursor-pointer"
                              title="Detail the percentage of profits the General Partner earns after priority interest and GP catch-up. This aligns the General Partner’s incentives with maximizing the SPV's profitability."
                            />
                          </div>
                          <button
                            onClick={() => setIsCarriedSelected(true)}
                            className={`${
                              isCarriedSelected ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                            Yes
                          </button>
                                ...
                                <input
                                  ...
                                  onChange={(e) =>
                                    setAnswers({
                                      ...
                                      PerformanceFees: {
                                        ...answers?.PerformanceFees,
                                        CarriedPercentage: e.target.value,
                                      },
                                    })
                                  }
                                />
                          ...
                          <button
                            onClick={() => setIsCarriedSelected(false)}
                            className={`${
                              !isCarriedSelected ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                          ...
                          <button
                            onClick={() => {
                              ...
                              setAnswers({
                                ...
                                PerformanceFees: {
                                  ...answers?.PerformanceFees,
                                  PriorityInterest: isPriorityInterestSelected
                                    ? "yes"
                                    : "no",
                                  GpCatchUp: isGpCatchUpSelected ? "yes" : "no",
                                  Carried: isCarriedSelected ? "yes" : "no",
                                },
                              });
                            }}
                            type="button"
                  ...
                  17: (
                    <>
                      <div>
                        <form
                          onSubmit={managementCorporationHandleSubmit(
                            managementCorporationOnSubmit
                          )}
                        >
                          <div className="py-[50px]">
                            <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                    ...
                    <>
                      <div>
                        <div className="py-[50px]">
                          ...
                          <form
                            onSubmit={managementLegalHandleSubmit(
                              managementLegalOnSubmit
                            )}
                          >
                            <div className="flex flex-col gap-[20px]">
                              <div className="flex w-full items-center relative">
                  ...
                  19: (
                    <>
                      <div>
                        <form
                          onSubmit={managementLegalDocumentHandleSubmit(
                            managementLegalDocumentOnSubmit
                          )}
                        >
                          <div className="py-[50px]">
                            <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                  ...
                  20: (
                    <>
                      <form
                        onSubmit={corporationCompanyDetailHandleSubmit(
                          corporationCompanyDetailOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                          ...
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                {...corporationCompanyDetailRegister(
                                  "CompanyName"
                                )}
                              />
                  ...
                  21: (
                    <>
                      <form
                        onSubmit={corporationLegalRepresentationHandleSubmit(
                          corporationLegalRepresentationOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                          ...
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                placeholder={"First name"}
                                type="text"
                                {...corporationLegalRepresentationRegister(
                                  "FirstName"
                                )}
                              ...
                              {corporationLegalRepresentationErrors.FirstName && (
                                <span className="text-[11px] text-[red] absolute left-[220px] bottom-[-15px]">
                                  {
                                    corporationLegalRepresentationErrors
                                      .FirstName.message
                                  }
                                </span>
                              )}
            ...
            "
                  ...
                  22: (
                    <>
                      <form
                        onSubmit={corporationBeneficiaryHandleSubmit(
                          corporationBeneficiaryOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                          ...
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                {...corporationBeneficiaryRegister(
                                  "HoldingPercentage"
                                )}
                              />
                              {corporationBeneficiaryErrors.HoldingPercentage && (
                                <span className="text-[11px] text-[red] absolute left-[220px] bottom-[-15px]">
                                  {
                                    corporationBeneficiaryErrors
                                      .HoldingPercentage.message
                                  }
                                </span>
                              )}
                            </div>
                  ...
                  23: (
                    <>
                      <div className="py-[50px]">
                        <form
                          onSubmit={effectBeneficiaryDocumentHandleSubmit(
                            effectBeneficiaryDocumentOnSubmit
                          )}
                        >
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                            Effective beneficiaries
                          ...
                          <p className="pb-[20px] text-[17px] font-[500] text-[#315B3F]">
                            Person Name :{" "}
                            {getLastBeneficiaryFirstName(answers, "associate")}{" "}
                          </p>
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full flex-col items-start relative">
                              <div className="">
                            ...
                            <div className="flex flex-col gap-4 justify-start items-start mb-5">
                              ...
                              <button
                                onClick={(e) => {
                                  e.preventDefault();
                                  setIsOtherBenificialSelected(true);
                                }}
                                className={`${
                                  isOtherBenificialSelected
                                    ? "border-[2px]"
                              ...
                              <button
                                onClick={(e) => {
                                  e.preventDefault();
                                  setIsOtherBenificialSelected(false);
                                }}
                                className={`${
                                  !isOtherBenificialSelected
                                    ? "border-[2px]"
                  ...
                  24: (
                    <>
                      <form
                        onSubmit={otherBenificialHandleSubmit(
                          otherBenificialOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                  ...
                  25: (
                    <>
                      <div className="py-[50px]">
                        <form
                          onSubmit={otherBeneficiaryDocumentHandleSubmit(
                            otherBeneficiaryDocumentOnSubmit
                          )}
                        >
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                            Other beneficial owners
                          ...
                          <div className="flex flex-col gap-[20px]">
                            ...
                            <div className="flex flex-col gap-4 justify-start items-start mb-5">
                              ...
                              <button
                                onClick={() =>
                                  setIsAgainBenificialSelected(true)
                                }
                                className={`${
                                  isAgainBenificialSelected
                                    ? "border-[2px]"
                              ...
                              <button
                                onClick={() =>
                                  setIsAgainBenificialSelected(false)
                                }
                                className={`${
                                  !isAgainBenificialSelected
                                    ? "border-[2px]"
                      ...
                      <div className="py-[50px]">
                        ...
                        <div className="pt-[20px] flex flex-col gap-[10px] w-[70%]">
                          <div
                            ...
                            className={`${
                              isConstituentSelected ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                            title="An individual who participated in the SPV as an investor, manager, or owner, bringing personal expertise or capital."
                          >
                            Physical person
                  ...
                  27: (
                    <>
                      <form
                        onSubmit={constituentPersonHandleSubmit(
                          constituentPersonOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p
                            className="pb-[10px] text-[25px] font-[500] text-[#315B3F]"
                            title="An individual who participated in the SPV as an investor, manager, or owner, bringing personal expertise or capital."
                          >
                            Physical Person
                          </p>
                  ...
                  28: (
                    <>
                      <form
                        onSubmit={constituentDocumentPersonHandleSubmit(
                          constituentDocumentPersonOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p
                          ...
                          <div className="flex w-full items-center mb-5 relative">
                            ...
                            <input
                              ...
                              placeholder={"Amount of contribution"}
                              type="number"
                              {...constituentDocumentPersonRegister(
                                "AmountContribution"
                              )}
                            ...
                            {constituentDocumentPersonErrors.AmountContribution && (
                              <span className="text-[11px] text-[red] absolute left-[220px] bottom-[-15px]">
                                {
                                  constituentDocumentPersonErrors
                                    .AmountContribution.message
                                }
                              </span>
                            )}
                  ...
                  29: (
                    <>
                      <div className="py-[50px]">
                        ...
                        <form
                          onSubmit={corporationHandleSubmit(
                            corporationOnSubmit
                          )}
                        >
                          <div className="flex flex-col gap-[25px]">
                  ...
                  30: (
                    <>
                      <div className="py-[50px]">
                        ...
                        <form
                          onSubmit={corporationLegalHandleSubmit(
                            corporationLegalOnSubmit
                          )}
                        >
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full items-center relative">
                  ...
                  31: (
                    <>
                      <form
                        onSubmit={constituentBeneficiaryHandleSubmit(
                          constituentBeneficiaryOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                          ...
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full items-center relative">
                              ...
                              <input
                                ...
                                placeholder={"Holding percentage"}
                                type="number"
                                {...constituentBeneficiaryRegister(
                                  "HoldingPercentage"
                                )}
                                // onChange={(e) => setEffectiveBenificiaryData({ ...effectiveBenificiaryData, HoldingPercentage: e.target.value })}
                              />
                  ...
                  32: (
                    <>
                      <form
                        onSubmit={constituentDocumentHandleSubmit(
                          constituentDocumentOnSubmit
                        )}
                      >
                        <div className="py-[50px]">
                          <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F]">
                          ...
                          <p className="pb-[20px] text-[17px] font-[500] text-[#315B3F]">
                            Person Name : {getLastBeneficiaryFirstName(answers)}{" "}
                          </p>
                          <div className="flex flex-col gap-[20px]">
                            <div className="flex w-full flex-col items-start relative">
                              <div className="">
                            ...
                            <div className="flex flex-col gap-4 justify-start items-start mb-5">
                              ...
                              <button
                                onClick={(e) => {
                                  e.preventDefault();
                                  setIsCorporationBenificialSelected(true);
                                }}
                                className={`${
                                  isCorporationBenificialSelected
                                    ? "border-[2px]"
                              ...
                              <button
                                onClick={(e) => {
                                  e.preventDefault();
                                  setIsCorporationBenificialSelected(false);
                                }}
                                className={`${
                                  !isCorporationBenificialSelected
                                    ? "border-[2px]"
                    ...
                    <>
                      <div className="py-[50px]">
                        <p className="pb-[20px] text-[18px] font-[500] text-[#315B3F] whitespace-nowrap">
                          ...
                          If, not, Overlord is happy without charging to{" "}
                          <br></br> offer its own headquarter for the entity. *
                        </p>
                        <div className="flex flex-col gap-1 justify-start items-start">
                          <button
                            onClick={(e) => {
                              setIsAvailableHeadQuarter(true);
                              setAnswers({
                                ...answers,
                                AvailableHeadQuarter: e.target.innerText,
                              });
                            }}
                            className={`${
                              isAvailableHeadQuarter ? "border-[2px]" : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
                            Yes
                          </button>
                          <button
                            onClick={(e) => {
                              setIsAvailableHeadQuarter(false);
                              setAnswers({
                                ...answers,
                                AvailableHeadQuarter: e.target.innerText,
                              });
                  ...
                  34: (
                    <>
                      <div className="py-[50px]">
                        <p className="pb-[20px] text-[25px] font-[500] text-[#315B3F] whitespace-nowrap">
                          Can you download a recent lease,<br></br>{" "}
                          domiciliation contract, EDF receipt or<br></br>{" "}
                          telephone bill for this address? *
                        </p>
                        <div className="flex flex-col gap-1 justify-start items-start">
                          <button
                            onClick={(e) => {
                              setIsDownloadSelected(true);
                              setAnswers({
                                ...answers,
                                DownloadLease: e.target.innerText,
                              });
                            }}
                            className={`${
                              isDownloadLeaseSelected
                                ? "border-[2px]"
                                : "border"
                            } cursor-pointer text-[15px] font-[400] text-[#315B3F] border-[#315B3F] rounded-[8px] p-[10px]`}
                          >
